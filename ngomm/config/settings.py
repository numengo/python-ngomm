...
NS_LOOKUP_EXCLUDE_FIELDS = ['authors', 'description', 'documentation', 'logo', 'changes', 'requirements', 'urls',
                            'settings', 'static', 'entry_points', 'properties', 'models', 'fixtures', 'shop', 'cms']
